...
- [ArchitectureViews.md](../architecture/ArchitectureViews.md): target-neutral behavior and runtime diagrams.
- [InterfaceContract.md](../architecture/InterfaceContract.md): behavior-level interface contracts.
...
- **Notes**: Detailed audio flow is shown in [ArchitectureViews.md](../architecture/ArchitectureViews.md).
...
- **Notes**: Parameter semantics are defined by the Parameter Contract in [InterfaceContract.md](../architecture/InterfaceContract.md).
...
- **Notes**: Bypass behavior is governed by the Effect Chain Execution Contract in [InterfaceContract.md](../architecture/InterfaceContract.md).
...
- **Notes**: The target-neutral chain update flow is shown in [ArchitectureViews.md](../architecture/ArchitectureViews.md).
...
- **Notes**: The target-neutral preset recall flow is shown in [ArchitectureViews.md](../architecture/ArchitectureViews.md).
...
- **Notes**: Persistence details remain target-specific and are represented through the Persistence Port Contract in [InterfaceContract.md](../architecture/InterfaceContract.md).
...
- **Notes**: Diagnostics and runtime health contracts are defined in [InterfaceContract.md](../architecture/InterfaceContract.md).
...
- **Notes**: Validation behavior is defined by the Configuration Validation Contract in [InterfaceContract.md](../architecture/InterfaceContract.md).
